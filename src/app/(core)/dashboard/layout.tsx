  ...
  return (
    <div className="min-h-screen flex bg-slate-50">
      ...
      <div className="flex-1 lg:pl-64 flex flex-col min-h-screen">
        {/* Mobile topbar */}
        <header className="lg:hidden sticky top-0 z-40 flex items-center gap-3 h-14 px-4 bg-white border-b border-slate-100">
          <DashboardMobileNav isHost={isHost} />
          <span className="text-base font-bold text-slate-900">Stayly</span>
        </header>
