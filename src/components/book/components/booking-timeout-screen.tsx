...
export function BookingTimeoutScreen({ onViewBookings, onHome }: BookingTimeoutScreenProps) {
  return (
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex justify-center mb-8">
          <div className="relative flex items-center justify-center">
            ...
            <div className="anim-scale-in size-16 rounded-full bg-amber-100 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 flex items-center justify-center">
              <Clock className="size-8 text-amber-600 dark:text-amber-400" strokeWidth={2} />
            </div>
          </div>
        </div>
        ...
        <div className="anim-fade-up-2 rounded-2xl border border-border bg-card shadow-sm overflow-hidden mb-4">
          <div className="bg-linear-to-r from-amber-500 to-yellow-500 px-5 py-3 flex items-center gap-2">
            ...
            <span className="text-white text-sm font-semibold">Verification Pending</span>
          </div>
          <div className="px-5 py-5">
            <p className="text-sm text-muted-foreground">
              We&apos;re waiting on a confirmation from the payment gateway. Check your
              email or visit your bookings page — we&apos;ll update you as soon as it clears.
            </p>
          </div>
        </div>
