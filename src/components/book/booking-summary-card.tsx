    ...
    <Card className="sticky top-24 shadow-md">
      <CardContent className="p-6">
        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            <p className="text-xs font-semibold text-foreground mb-0.5">Dates</p>
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between text-sm">
            <span className="text-foreground">
              ₹{pricePerNight.toLocaleString("en-IN", { maximumFractionDigits: 1 })} × {nights} nights
            </span>
            <span className="text-foreground">
          ...
          <div className="flex justify-between items-center">
            <span className="font-bold text-foreground">
              Total <span className="text-sm font-normal">{currency}</span>
            </span>
          ...
          <button
            type="button"
            className="text-sm text-foreground underline font-medium p-0"
