  ...
  return (
    <section className='relative bg-background-muted pt-16 pb-14 overflow-hidden'>
      ...
      <motion.div
        ...
        style={{
          background:
            'radial-gradient(circle, rgba(61,111,142,0.13) 0%, transparent 70%)',
          filter: 'blur(40px)',
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            'radial-gradient(ellipse, rgba(221,232,240,0.55) 0%, transparent 70%)',
          filter: 'blur(60px)',
        }}
      ...
      <div className='relative z-10 max-w-[1240px] mx-auto px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-[54%_46%] gap-10 items-center'>
        ...
        <div>
          {/* Trust pill */}
          <div className='inline-flex items-center gap-2 bg-primary-subtle border border-primary-foreground/70 rounded-full px-4 py-1.5 mb-7'>
