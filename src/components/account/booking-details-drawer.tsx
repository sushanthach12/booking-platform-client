        ...
        <div className="flex-1 px-6 py-6 space-y-6">
          ...
          <div className="space-y-1">
            ...
            <div className="rounded-xl border border-slate-100 bg-white divide-y divide-slate-50 overflow-hidden">
              ...
              <div className="px-4 py-3">
                <DetailRow label="Booking ID" value={`#${booking.id.slice(0, 8).toUpperCase()}`} />
              </div>
            </div>
          </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-white overflow-hidden">
              <div className="px-4 py-3 space-y-2.5">
                <DetailRow
                  ...
                  value={formatCurrency(pricePerNight * nights, booking.currency)}
                />
              </div>
              <Separator />
              <div className="px-4 py-3">
        ...
        <div className="shrink-0 border-t border-slate-100 px-6 py-4 space-y-2.5 bg-white">
          {booking.status === "confirmed" && (
            <Button asChild variant="outline" className="w-full rounded-xl gap-2">
              <Link href={`/properties/${booking.id}`} target="_blank">
